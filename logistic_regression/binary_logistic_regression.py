...
flags.DEFINE_string('train_file', '../data/dense.train', 'training data')
flags.DEFINE_string('test_file', '../data/dense.test', 'test data')
...
model = BinaryLogisticRegression(feature_num, dense)
y = model.forward()
